						...
						<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle" id="FormTitle">		
							<tr>
								<td bgcolor="#4D595D" colspan="3" valign="top">
									...
									<div class="formfontdesc" id="cmdDesc"><i>* 为了Frpc稳定运行，请开启虚拟内存功能！！！</i><br><a href="http://koolshare.cn/thread-6066-1-1.html"  target="_blank"><i>服务器搭建教程</i></a></div>
									...
									<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" style="margin-top:8px;">
                                        ...
                                        <tr>
										    <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(4)">日志记录</a></th>
											<td>
										...
										<tr>
										    <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(5)">日志等级</a></th>
											<td>
										...
										<tr>
										    <th width="20%"><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(6)">日志记录天数</a></th>
											<td>
                            	...
                            	<table id="conf_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable_table" style="margin-top:8px;">
									  	<thead>
									  		<tr>
												<td colspan="9">限制最多&nbsp;条数&nbsp;8)</td>
									  		</tr>
									  	</thead>
						
									  	<tr>
								  		  <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(7)">协议类型</a></th>
                                          <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(8)">服务名称</a></th>
                                          <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(9)">域名配置</a></th>
                                          <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(10)">内网主机地址</a></th>
                                          <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(11)">内网主机端口</a></th>
                                          <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(12)">远程主机端口</a></th>
                                          <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(13)">加密</a></th>
                                          <th><a class="hintstyle" href="javascript:void(0);" onclick="openssHint(14)">压缩</a></th>
						        		  <th>添加/删除</th>
									  	</tr>			  
									  	<tr>							  		
				            			<td>
											<select id="proto_node" name="proto_node" style="width:80px;margin:0px 0px 0px 2px;" class="input_option" >
                                         ...
                                         <td>
											<input type="text" id="subname_node" name="subname_node" class="input_6_table" maxlength="50" placeholder=""/>
				            			</td>
                                         <td>
											<input type="text" id="subdomain_node" name="subdomain_node" class="input_15_table" maxlength="250" placeholder=""/>
				            			</td>
                                        <td>
											<input type="text" id="localhost_node" name="localhost_node" class="input_15_table" maxlength="20" placeholder=""/>
				            			</td>
                                        <td>
