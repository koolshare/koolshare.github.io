...
function version_show(){
    ...
    $j.ajax({
        url: 'https://raw.githubusercontent.com/koolshare/koolshare.github.io/mips_softerware_center/adbyby/config.json.js',
        type: 'GET',
...
<body onload="init();">
	...
	<input type="hidden" name="SystemCmd" onkeydown="onSubmitCtrl(this, ' Refresh ')" value="adbyby_config.sh"/>
