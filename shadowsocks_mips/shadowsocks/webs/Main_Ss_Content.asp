...
function version_show(){
	if (db_ss['ss_basic_version_local'] != db_ss['ss_basic_version_web'] && db_ss['ss_basic_version_web'] !== "undefined"){
		//$j("#ss_version_show").html("<i>有新版本：mipsel " + db_ss['ss_basic_version_web']);
		$j("#ss_version_show").html("<i>当前版本：mipsel " + db_ss['ss_basic_version_local']);
											...
											<th>ShadowSocks 开关</th>
												<td colspan="2">
													...
													<div id="update_button" style="padding-top:5px;margin-left:100px;margin-top:-38px;float: left;">
														...
														<a style="margin-left: 178px;" href="https://github.com/koolshare/koolshare.github.io/blob/master/shadowsocks_mips/Changelog.txt" target="_blank"><em>[<u> 更新日志 </u>]</em></a>
													</div>
