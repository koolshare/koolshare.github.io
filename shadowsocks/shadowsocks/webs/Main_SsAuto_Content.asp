...
<span id="dns_plan_foreign2">选择由ss-tunnel通过udp转发给SS服务器解析的DNS，默认【Goole DNS1】<br/>
！！ss-tunnel需要ss账号支持udp转发才能使用！！</span>
<span id="dns_plan_foreign3">在上面自定义由ss-tunnel通过udp转发给SS服务器解析的DNS</span></td>
</tr>
