...
function conf_to_obj(){
	if(typeof db_ss != "undefined") {
		for(var field in db_ss) {
			...
			var temp_ss = ["ss_kcptun_isp_website_web", "ss_kcptun_wan_white_ip", "ss_kcptun_wan_black_ip", "ss_kcptun_wan_white_domain", "ss_kcptun_wan_black_domain", "ss_kcptun_dnsmasq"];
...
function updateOptions(){
	...
	document.form.action = "/applydb.cgi?p=ss_kcptun_";
...
function update_visibility(){
	rdc = document.form.ss_kcptun_dns_china.value;
	rdf = document.form.ss_kcptun_dns_foreign.value;
	srpm= document.form.ss_kcptun_pdnsd_method.value
	showhide("show_isp_dns", (rdc == "1"));
	showhide("ss_kcptun_dns_china_user", (rdc == "5"));
	showhide("ss_kcptun_dns_china_user_txt1", (rdc !== "5"));
	showhide("ss_kcptun_dns_china_user_txt2", (rdc == "5"));
	showhide("ss_kcptun_opendns", (rdf == "1"));
	showhide("pdnsd_up_stream_tcp", (rdf == "6" && srpm == "2"));
	showhide("pdnsd_up_stream_udp", (rdf == "6" && srpm == "1"));
	showhide("ss_kcptun_pdnsd_udp_server_dns2socks", (rdf == "6" && srpm == "1" && document.form.ss_kcptun_pdnsd_udp_server.value == 1));
	showhide("ss_kcptun_pdnsd_udp_server_dnscrypt", (rdf == "6" && srpm == "1" && document.form.ss_kcptun_pdnsd_udp_server.value == 2));
	showhide("pdnsd_cache", (rdf == "6"));
	showhide("pdnsd_method", (rdf == "6"));
	showhide("dns_plan_foreign1", (rdf == "1"));
	showhide("ss_kcptun_dns2socks_user", (rdf == "4"));
	showhide("dns_plan_foreign0", (rdf == "4"));
	generate_options();
}

function generate_options(){
	var confs = ["4armed",  "cisco(opendns)",  "cisco-familyshield",  "cisco-ipv6",  "cisco-port53",  "cloudns-can",  "cloudns-syd",  "cs-cawest",  "cs-cfi",  "cs-cfii",  "cs-ch",  "cs-de",  "cs-fr",  "cs-fr2",  "cs-rome",  "cs-useast",  "cs-usnorth",  "cs-ussouth",  "cs-ussouth2",  "cs-uswest",  "cs-uswest2",  "d0wn-bg-ns1",  "d0wn-ch-ns1",  "d0wn-de-ns1",  "d0wn-fr-ns2",  "d0wn-gr-ns1",  "d0wn-hk-ns1",  "d0wn-it-ns1",  "d0wn-lv-ns1",  "d0wn-nl-ns1",  "d0wn-nl-ns2",  "d0wn-random-ns1",  "d0wn-random-ns2",  "d0wn-ro-ns1",  "d0wn-ru-ns1",  "d0wn-tz-ns1",  "d0wn-ua-ns1",  "dnscrypt.eu-dk",  "dnscrypt.eu-dk-ipv6",  "dnscrypt.eu-nl",  "dnscrypt.eu-nl-ipv6",  "dnscrypt.org-fr",  "fvz-rec-at-vie-01",  "fvz-rec-ca-tor-01",  "fvz-rec-ca-tor-01-ipv6",  "fvz-rec-de-fra-01",  "fvz-rec-gb-brs-01",  "fvz-rec-gb-lon-01",  "fvz-rec-gb-lon-03",  "fvz-rec-hk-ztw-01",  "fvz-rec-ie-du-01",  "fvz-rec-no-osl-01",  "fvz-rec-nz-akl-01",  "fvz-rec-nz-akl-01-ipv6",  "fvz-rec-us-ler-01",  "fvz-rec-us-mia-01",  "ipkcptunator",  "ns0.dnscrypt.is",  "okturtles",  "opennic-tumabox",  "ovpnto-ro",  "ovpnto-se",  "ovpnto-se-ipv6",  "shea-us-noads",  "shea-us-noads-ipv6",  "soltysiak",  "soltysiak-ipv6",  "yandex"];
	var obj=document.getElementById('ss_kcptun_opendns'); 
	var obj1=document.getElementById('ss_kcptun_pdnsd_udp_server_dnscrypt'); 
...
function show_develop_function(){
	if (db_ss['ss_basic_user'] == undefined){
		var obj2=document.getElementById('ss_kcptun_dns_foreign');
...
<form method="post" name="form" action="/applydb.cgi?p=ss" target="hidden_frame">
	...
	<input type="hidden" id="ss_basic_mode" name="ss_basic_mode" value="6" />
							...
							<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3" class="FormTitle" id="FormTitle">
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										<div>&nbsp;</div>
										<div class="formfonttitle">kcptun - 高级设置</div>
										...
										<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
											...
											<tr id="dns_plan_china">
												...
												<td>
													<select id="ss_kcptun_dns_china" name="ss_kcptun_dns_china" class="input_option" onclick="update_visibility();" >
													...
													<input type="text" class="ssconfig input_ss_table" id="ss_kcptun_dns_china_user" name="ss_kcptun_dns_china_user" maxlength="100" value="">
													<span id="show_isp_dns">【<% nvram_get("wan0_dns"); %>】</span> <br/>
													<span id="ss_kcptun_dns_china_user_txt1">默认：运营商DNS【用于解析国内6000+个域名】</span>
													<span id="ss_kcptun_dns_china_user_txt2">确保你自定义输入的国内DNS在chnroute中</span>
												</td>
											</tr>
											<tr id="dns_plan_foreign">
												<th width="20%">选择国外DNS</th>
												<td>
													<select id="ss_kcptun_dns_foreign" name="ss_kcptun_dns_foreign" class="input_option" onclick="update_visibility();" >
													...
													<select id="ss_kcptun_opendns" name="ss_kcptun_opendns" class="input_option"></select>
													<input type="text" class="ssconfig input_ss_table" id="ss_kcptun_dns2socks_user" name="ss_kcptun_dns2socks_user" maxlength="100" placeholder="需端口号如：8.8.8.8:53" value="8.8.8.8:53">
													<br/>
											...
											<tr id="pdnsd_method">
												...
												<td>
													<select id="ss_kcptun_pdnsd_method" name="ss_kcptun_pdnsd_method" class="input_option" onclick="update_visibility();" >
											...
											<tr id="pdnsd_up_stream_tcp">
												...
												<td>
													<input type="text" class="ssconfig input_ss_table" id="ss_kcptun_pdnsd_server_ip" name="ss_kcptun_pdnsd_server_ip" placeholder="DNS地址：8.8.4.4" style="width:128px;" maxlength="100" value="8.8.4.4">
													：
													<input type="text" class="ssconfig input_ss_table" id="ss_kcptun_pdnsd_server_port" name="ss_kcptun_pdnsd_server_port" placeholder="DNS端口" style="width:50px;" maxlength="6" value="53">
											...
											<tr id="pdnsd_up_stream_udp">
												...
												<td>
													<select id="ss_kcptun_pdnsd_udp_server" name="ss_kcptun_pdnsd_udp_server" class="input_option" onclick="update_visibility();" >
														<option value="1">DNS2SOCKS</option>
														<option value="2">dnscrypt-proxy</option>
													</select>
													<input type="text" class="ssconfig input_ss_table" id="ss_kcptun_pdnsd_udp_server_dns2socks" name="ss_kcptun_pdnsd_udp_server_dns2socks" style="width:128px;" maxlength="100" placeholder="需端口号如：8.8.8.8:53" value="8.8.8.8:53">
													<select id="ss_kcptun_pdnsd_udp_server_dnscrypt" name="ss_kcptun_pdnsd_udp_server_dnscrypt" class="input_option"></select>
												</td>
											</tr>
											<tr id="pdnsd_cache">
												<th width="20%"><font color="#66FF66">&nbsp;&nbsp;&nbsp;&nbsp;*pdnsd缓存设置</font></th>
												<td>
													<input type="text" class="ssconfig input_ss_table" id="ss_kcptun_pdnsd_server_cache_min" name="ss_kcptun_pdnsd_server_cache_min" title="最小TTL时间" style="width:30px;" maxlength="100" value="24h">
													→
													<input type="text" class="ssconfig input_ss_table" id="ss_kcptun_pdnsd_server_cache_max" name="ss_kcptun_pdnsd_server_cache_max" title="最长TTL时间" style="width:30px;" maxlength="100" value="1w">
...
# 注意：不支持通配符！" cols="50" rows="8" id="ss_kcptun_isp_website_web" name="ss_kcptun_isp_website_web" style="width:99%; font-family:'Courier New', 'Courier', 'mono'; font-size:12px;background:#475A5F;color:#FFFFFF;"></textarea>
												</td>
											</tr>
										</table>
...
3.3.3.3
4.4.4.4/24
# 因为默认大陆的ip都不会走SS，所以此处填入国外IP/CIDR更有意义！" cols="50" rows="8" id="ss_kcptun_wan_white_ip" name="ss_kcptun_wan_white_ip" style="width:99%; font-family:'Courier New', 'Courier', 'mono'; font-size:12px;background:#475A5F;color:#FFFFFF;"></textarea>
												</td>
											</tr>
											<tr>
...
# 需要清空电脑DNS缓存，才能立即看到效果。" cols="50" rows="8" id="ss_kcptun_wan_white_domain" name="ss_kcptun_wan_white_domain" style="width:99%; font-family:'Courier New', 'Courier', 'mono'; font-size:12px;background:#475A5F;color:#FFFFFF;"></textarea>
												</td>
											</tr>
										</table>
										<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
...
6.6.6.6
7.7.7.7/8
# 因为默认大陆以外ip都会走SS，所以此处填入国内IP/CIDR更有意义！" cols="50" rows="8" id="ss_kcptun_wan_black_ip" name="ss_kcptun_wan_black_ip" style="width:99%; font-family:'Courier New', 'Courier', 'mono'; font-size:12px;background:#475A5F;color:#FFFFFF;"></textarea>
												</td>
											</tr>
											<tr>
...
# 需要清空电脑DNS缓存，才能立即看到效果。" cols="50" rows="8" id="ss_kcptun_wan_black_domain" name="ss_kcptun_wan_black_domain" style="width:99%; font-family:'Courier New', 'Courier', 'mono'; font-size:12px;background:#475A5F;color:#FFFFFF;"></textarea>
												</td>
											</tr>
										</table>
										<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
...
# 防DNS劫持设置：
bogus-nxdomain=220.250.64.18" rows=12 style="width:99%; font-family:'Courier New', 'Courier', 'mono'; font-size:12px;background:#475A5F;color:#FFFFFF;" id="ss_kcptun_dnsmasq" name="ss_kcptun_dnsmasq" title=""></textarea>
												</td>
											</tr>
										</table>
									<div class="apply_gen">
									...
									<blockquote>
									<h4>● DNS2SOCKS </h4>
									<p> 作用是将 DNS请求通过一个SOCKS隧道转发到DNS服务器，和ss-tunnel类似，不过DNS2SOCKS是利用了SOCK5隧道代理，ss-tunnel是利用了加密UDP；该DNS方案不受到ss服务是否支持udp限制，不受到运营商是否封Opendns限制，只要能建立socoks5链接，就能使用。</p>
