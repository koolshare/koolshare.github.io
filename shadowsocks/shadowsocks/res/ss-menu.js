function menu_hook(title, tab) {
	...
	if(enable_ss == "1" && enable_soft == "1"){
		tabtitle[tabtitle.length -2] = new Array("", "shadowsocks设置", "Socks5设置");
		tablink[tablink.length -2] = new Array("", "Main_Ss_Content.asp",  "Main_SsLocal_Content.asp");
	}else{
		tabtitle[tabtitle.length -1] = new Array("", "shadowsocks设置", "Socks5设置");
		tablink[tablink.length -1] = new Array("", "Main_Ss_Content.asp",  "Main_SsLocal_Content.asp");
	}
}
